...
<div class="row">
    <div class="col-lg-8">
        <h1 class="h3 mb-4">Edit Recipe</h1>
                    ...
                    <div id="ingredients-container">
                        @foreach ($recipe->ingredients as $index => $ingredient)
                            <div class="ingredient-row row mb-2">
                                ...
                                <div class="col-md-3">
                                    <input type="text" class="form-control" name="ingredients[{{ $index }}][quantity]" placeholder="Quantity" value="{{ $ingredient->pivot->quantity }}">
                                </div>
                                <div class="col-md-2">
                                    <input type="text" class="form-control" name="ingredients[{{ $index }}][unit]" placeholder="Unit" value="{{ $ingredient->pivot->unit }}">
                                </div>
                                <div class="col-md-2">
                    ...
                    <div id="steps-container">
                        @foreach ($recipe->etapes->sortBy('step_number') as $index => $etape)
                            <div class="step-row row mb-2">
                                <div class="col-md-2">
                                    <input type="number" class="form-control" name="etapes[{{ $index }}][step_number]" placeholder="#" min="1" value="{{ $etape->step_number }}" required>
                                </div>
                                <div class="col-md-8">
                                    <textarea class="form-control" name="etapes[{{ $index }}][instruction]" placeholder="Instruction" rows="2" required>{{ $etape->instruction }}</textarea>
                                </div>
                                <div class="col-md-2">
